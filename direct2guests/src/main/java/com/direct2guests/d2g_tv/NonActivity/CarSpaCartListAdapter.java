...
//        quantity.setTypeface(fontPathBoldCav);
        ...
        delete.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean b) {
                if(b){
                    view.setBackgroundTintList(ContextCompat.getColorStateList(context, R.color.questyellow));
                    button = 2;
                }else{
                    view.setBackgroundTintList(ContextCompat.getColorStateList(context, R.color.questpurple));
                }
            }
        });
